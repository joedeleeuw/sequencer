...
declare namespace Tone {
  ...
  var AmplitudeEnvelope: {
    new (
      ...
      sustain?: number,
      release?: Tone.Time
    ): Tone.AmplitudeEnvelope; //TODO: Change 'any' to 'Tone.Time | Object'
  };
  ...
  interface Instrument extends Tone {
    ...
    triggerAttackRelease(
      ...
      time?: Tone.Time,
      velocity?: number
    ): Tone.Instrument; //Todo: string | number
  ...
  interface PolySynth extends Tone.Instrument {
    ...
    triggerAttackRelease(
      ...
      time?: Tone.Time,
      velocity?: number
    ): Tone.PolySynth; //todo: string | number | Object | string[] | number[]
  ...
  var ScaledEnvelope: {
    new (
      ...
      sustain?: number,
      release?: Tone.Time
    ): Tone.ScaledEnvelope; //TODO: Change 'any' to 'Tone.Time | Object'
  };
